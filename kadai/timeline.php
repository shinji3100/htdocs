...
$stmt = $pdo->prepare("SELECT * FROM kadai_table INNER JOIN kadai_user_table ON kadai_table.u_id = kadai_user_table.u_id ORDER BY timestamp DESC");
$status = $stmt->execute();
